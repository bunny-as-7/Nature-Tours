...
const validator = require('validator');   // to check whether the provided data, meets the naming standards or not
...
userSchema.pre(/^find/, function(next) {
  // this points to the current query, checking if the user is active 
